...
def run_experiment(config):
    ...
    print("Loading data...")
    np.random.seed(seed)
    X_train, X_val, y_train, y_val = load_electricity_tiny()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--benchmarks", nargs="+", default=['OnlineMMDPlus','Reservoir','OCS','BCSR'],
                        help="Which methods to run")
    parser.add_argument("--coreset_sizes", nargs="+", type=int, default=list(range(5, 10)))
    parser.add_argument("--dataset_subset_size", type=int, default=2500)
    parser.add_argument("--batch_size", type=int, default=50)
    parser.add_argument("--n_rff_components", type=int, default=40)
